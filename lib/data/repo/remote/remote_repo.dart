...
import 'package:belks_tube/data/repo/remote/base_yt_repository.dart';
...
class RemoteRepo with RepositoryImplMixin implements BaseYtRepository {
  RemoteRepo(this.ref);
  ...
  Future<Either<DataFailures, Channel>> fetchChannel(
    ...
    return safeFunc(() async {
      final dto = await client.fetchChannel(channelId: channelId);
      return dto.toDomain();
    });
  }
}
